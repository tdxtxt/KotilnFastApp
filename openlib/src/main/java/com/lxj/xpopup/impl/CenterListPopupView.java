...
public class CenterListPopupView extends CenterPopupView {
    ...
    protected void initPopupContent() {
        ...
        final RQuickAdapter<String> adapter = new RQuickAdapter<String>(getContext(), bindItemLayoutId == 0 ? R.layout._xpopup_adapter_text_match : bindItemLayoutId, Arrays.asList(data)) {
            @Override
