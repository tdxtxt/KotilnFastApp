...
public class StatusBarHelper {
    ...
    public static void setLightMode(Activity activity) {
        if (OSUtils.isMiui()) {
            setMIUIStatusBarDarkMode(activity.getWindow(), false);
        } else if (OSUtils.isFlyme()) {
            setFlymeStatusBarDarkMode(activity.getWindow(), false);
        } else if (OSUtils.isOppo()) {
            setOppoStatusBarDarkMode(activity.getWindow(), false);
        } else {
    ...
    public static void setDarkMode(Activity activity) {
        if (OSUtils.isMiui()) {
            setMIUIStatusBarDarkMode(activity.getWindow(), true);
        } else if (OSUtils.isFlyme()) {
            setFlymeStatusBarDarkMode(activity.getWindow(), true);
        } else if (OSUtils.isOppo()) {
            setOppoStatusBarDarkMode(activity.getWindow(), true);
        } else {
    ...
    static class FlymeStatusBarUtils{
